...
import '../../../common/baswidgets/custom_button_widget.dart';
import '../../../common/baswidgets/custom_textfield_widget.dart';
...
import 'condition_check_box_widget.dart';
                    ...
                    Container(margin: const EdgeInsets.all(Dimensions.paddingSizeDefault), child: Hero(
                      ...
                      child: CustomButton(
                        ...
                        onTap: authProvider.isAcceptTerms ?  (){
                          ...
                          String phoneNumber = authProvider.countryDialCode + rawInput;
                          ...
                          if(signUpFormKey.currentState?.validate() ?? false) {
                            ...
                            // debugPrint('==================Registering user using==================');
