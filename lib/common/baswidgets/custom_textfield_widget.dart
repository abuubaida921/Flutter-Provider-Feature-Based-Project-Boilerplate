...
import '../../features/auth/widgets/code_picker_widget.dart';
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
           ...
           // labelText : widget.showLabelText? widget.labelText?? widget.hintText : null,
            ...
            label: Text.rich(overflow:TextOverflow.ellipsis,softWrap: true,TextSpan(children: [
              TextSpan(text: widget.labelText??'', style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
              if(widget.required && widget.labelText != null)
              TextSpan(text : ' *', style: textRegular.copyWith(color: Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeSmall))
            ])),
